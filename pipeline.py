...
def run_pipeline():
    """Run pipeline to aggregate trips by station."""
...
if __name__ == "__main__":
    ...
    PARSER = argparse.ArgumentParser("Set up Beam pipeline for the London "
                                     + "Cycle Hire data (work in progress)")
    
    print("This script works only on python 3.5. It is still a work in " 
          + "progress. It should return counts of trips aggregated by station")
